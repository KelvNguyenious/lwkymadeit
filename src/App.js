...
const projects = [
  {
    ...
    images: [
      "https://i.imgur.com/5QVgpld.png","https://i.imgur.com/Eb7Rfd1.png","https://i.imgur.com/Etp7KkK.png",
      "https://i.imgur.com/zuGSLzy.png","https://i.imgur.com/qhsEdVv.png","https://i.imgur.com/GzTL3o3.png",
      "https://i.imgur.com/nmTlNu4.png","https://i.imgur.com/qEMkpiF.png","https://i.imgur.com/IOy1V5I.png",
  ...
  },
  {
    ...
    images: [
      "https://i.imgur.com/NsKIcpi.png","https://i.imgur.com/hBgo8lA.png","https://i.imgur.com/ZIizxk4.png",
      "https://i.imgur.com/UEm8EjC.png","https://i.imgur.com/PDfbxTj.png","https://i.imgur.com/i6gkD4z.png",
      "https://i.imgur.com/hNhHyRF.png","https://i.imgur.com/rMOT2EB.png","https://i.imgur.com/z5yxhO8.jpeg",
      "https://i.imgur.com/pMgaT4W.jpeg","https://i.imgur.com/xWpNFuY.png","https://i.imgur.com/f6wTBrV.jpeg",
      "https://i.imgur.com/6sjPXi0.jpeg","https://i.imgur.com/J66WcXG.jpeg","https://i.imgur.com/4C8v1Wg.jpeg",
      "https://i.imgur.com/hj2wksd.jpeg","https://i.imgur.com/q8Lsjmp.jpeg","https://i.imgur.com/B68ZcTj.png",
      "https://i.imgur.com/H8fSHlr.jpeg","https://i.imgur.com/h3IqsmM.jpeg","https://i.imgur.com/ZPVGG2P.jpeg",
      "https://i.imgur.com/aqzfqsu.jpeg","https://i.imgur.com/FtNU5CD.jpeg","https://i.imgur.com/hAbJlsm.jpeg",
    ],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/c9M8Tr2.png","https://i.imgur.com/E5q5a8S.jpeg","https://i.imgur.com/BxBcdOs.jpeg","https://i.imgur.com/l6KRran.jpeg"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/q9nRz0B.png","https://i.imgur.com/SBVoOVb.png","https://i.imgur.com/cRbVI8q.png"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/W7U5exQ.png","https://i.imgur.com/7nDO7fT.png","https://i.imgur.com/BOn78SO.jpeg","https://i.imgur.com/FJ6WB3a.jpeg","https://i.imgur.com/Rl6fQz6.jpeg","https://i.imgur.com/474ijaO.jpeg","https://i.imgur.com/QXrgYbw.jpeg","https://i.imgur.com/ouLSZDh.jpeg","https://i.imgur.com/E1V7KGe.jpeg"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/310MyTH.png","https://i.imgur.com/GFCWYJa.png","https://i.imgur.com/ahBZ0WR.jpeg","https://i.imgur.com/oC5oGPh.jpeg"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/jcdZZuu.jpeg","https://i.imgur.com/zdK5yjH.png","https://i.imgur.com/JnaxnuN.png"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/J8grnUR.png","https://i.imgur.com/EN0OwCH.png"],
  ...
  },
  {
    ...
    images: ["https://i.imgur.com/wcKKS9m.png","https://i.imgur.com/yC9tbPm.png"],
...
const productItems = [
  "https://i.imgur.com/0x1y3Qs.png","https://i.imgur.com/JhlJpI1.png","https://i.imgur.com/zwx25o8.png",
  "https://i.imgur.com/nsbnAvi.png","https://i.imgur.com/d1xZ2mm.png","https://i.imgur.com/SJezu9I.png",
  "https://i.imgur.com/hj88Ux2.png","https://i.imgur.com/Ri692ar.png","https://i.imgur.com/fjCdclY.png",
  "https://i.imgur.com/c0iwrl9.png","https://i.imgur.com/5tYyeV2.png","https://i.imgur.com/tpXT2Mt.png",
  "https://i.imgur.com/RxCLJLw.png","https://i.imgur.com/ciRizEx.png","https://i.imgur.com/mNcYGHv.png",
  "https://i.imgur.com/odjAnAn.png","https://i.imgur.com/lKP9un3.png","https://i.imgur.com/jYCyl3R.png",
  "https://i.imgur.com/UihfjPt.png","https://i.imgur.com/mdz7mma.png","https://i.imgur.com/TvO4LLz.png",
  "https://i.imgur.com/omcr8aA.png","https://i.imgur.com/4he8f1b.png","https://i.imgur.com/MK0tP7l.png",
  "https://i.imgur.com/F37nHsZ.png","https://i.imgur.com/LTjpA7X.png","https://i.imgur.com/VYPK4hr.png",
  "https://i.imgur.com/bYzIxQe.png","https://i.imgur.com/RYrRmDb.png","https://i.imgur.com/MAufv67.png",
  "https://i.imgur.com/fScdOoq.png","https://i.imgur.com/FaTktrZ.png","https://i.imgur.com/qAvsDQ8.png",
  "https://i.imgur.com/ZtMUvoZ.png","https://i.imgur.com/7BIRgwk.png","https://i.imgur.com/rn75SR0.png",
...
const photoCollections = [
  { id: "all", label: "All" },{ id: "bodega", label: "BODEGA" },{ id: "bet-on-self", label: "BET ON SELF." },
  { id: "from-the-homies", label: "FROM THE HOMIES" },{ id: "dguw", label: "DON'T GIVE UP, WORLD!" },
  { id: "kims-baby-boy", label: "KIM'S BABY BOY" },{ id: "utopia-brand", label: "UTOPIA BRAND" },
  { id: "deco", label: "DECO" },{ id: "potentia-x-viribus", label: "POTENTIA X VIRIBUS" },
];
...
function ProductLightbox({ item, onClose, onPrev, onNext }) {
  ...
  useEffect(() => {
    ...
    const h = (e) => { if (e.key === "Escape") cl(); if (e.key === "ArrowLeft") onPrev(); if (e.key === "ArrowRight") onNext(); };
    window.addEventListener("keydown", h);
    return () => { document.body.style.overflow = ""; window.removeEventListener("keydown", h); };
  }, []);
  const cl = () => { setShow(false); setTimeout(onClose, 350); };
  return (
    <div onClick={cl} style={{ position: "fixed", inset: 0, zIndex: 2000, background: show ? "rgba(250,250,248,0.96)" : "rgba(250,250,248,0)", backdropFilter: "blur(16px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "background 0.35s ease" }}>
      <button onClick={cl} style={{ position: "absolute", top: isMobile ? 16 : 32, right: isMobile ? 16 : 32, background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 14, letterSpacing: "0.08em", textTransform: "uppercase", color: "#1a1a1a", padding: "8px 0", borderBottom: "1px solid #1a1a1a" }}>Close</button>
      {!isMobile && <button onClick={(e) => { e.stopPropagation(); onPrev(); }} style={{ position: "absolute", left: 32, top: "50%", transform: "translateY(-50%)", background: "none", border: "1px solid #ccc", borderRadius: "50%", width: 48, height: 48, cursor: "pointer", fontSize: 20, color: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center" }}>&#8592;</button>}
      {!isMobile && <button onClick={(e) => { e.stopPropagation(); onNext(); }} style={{ position: "absolute", right: 32, top: "50%", transform: "translateY(-50%)", background: "none", border: "1px solid #ccc", borderRadius: "50%", width: 48, height: 48, cursor: "pointer", fontSize: 20, color: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center" }}>&#8594;</button>}
      <img onClick={(e) => e.stopPropagation()} src={item.imageLg} alt="" style={{ maxWidth: isMobile ? "92vw" : "70vw", maxHeight: isMobile ? "80vh" : "75vh", objectFit: "contain", opacity: show ? 1 : 0, transform: show ? "scale(1)" : "scale(0.92)", transition: "opacity 0.4s ease, transform 0.4s cubic-bezier(0.16,1,0.3,1)", cursor: "default" }} />
    </div>
  );
}
...
function ProductGridItem({ item, index, onClick }) {
  ...
  return (
    <div ref={ref} onClick={onClick} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(24px)", transition: `opacity 0.6s cubic-bezier(0.16,1,0.3,1) ${Math.min(index*40,400)}ms, transform 0.6s cubic-bezier(0.16,1,0.3,1) ${Math.min(index*40,400)}ms` }}>
      <div style={{ width: "100%", aspectRatio: "1/1", display: "flex", alignItems: "center", justifyContent: "center", background: "transparent" }}>
        <LazyImage src={item.image} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.5s cubic-bezier(0.16,1,0.3,1)", mixBlendMode: "multiply" }} />
      </div>
    </div>
  );
}
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 60, alignItems: "start" }}>
          <div style={isMobile ? {} : { position: "sticky", top: 120, maxHeight: "calc(100vh - 160px)", overflowY: "auto", paddingBottom: 40, paddingRight: 16 }}>
            ...
            <div style={{ borderTop: "1px solid #e0e0dc", paddingTop: 24 }}>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: "#999", marginBottom: 12 }}>About</p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 14 : 16, lineHeight: 1.8, color: "#3a3a3a", margin: 0 }}>{project.description}</p>
            </div>
...
function CollaborationsCarousel({ onSelectProject }) {
  ...
  useEffect(() => { const u = () => { const w = window.innerWidth; if (w < 600) setCardWidth(w - 60); else if (w < 900) setCardWidth(400); else setCardWidth(480); }; u(); window.addEventListener("resize", u); return () => window.removeEventListener("resize", u); }, []);
  ...
  const handlePointerDown = (e) => { setIsDragging(true); setDragStartX(e.clientX || e.touches?.[0]?.clientX || 0); setDragOffset(0); };
  const handlePointerMove = (e) => { if (!isDragging) return; const x = e.clientX || e.touches?.[0]?.clientX || 0; setDragOffset(x - dragStartX); };
  const handlePointerUp = () => { if (!isDragging) return; setIsDragging(false); const threshold = cardWidth * 0.2; if (dragOffset < -threshold) goTo(currentIndex + 1); else if (dragOffset > threshold) goTo(currentIndex - 1); setDragOffset(0); };

  useEffect(() => { const h = (e) => { if (e.key === "ArrowLeft") goTo(currentIndex - 1); if (e.key === "ArrowRight") goTo(currentIndex + 1); }; window.addEventListener("keydown", h); return () => window.removeEventListener("keydown", h); }, [currentIndex]);

  const wheelAccum = useRef(0); const wheelTimeout = useRef(null); const wheelLocked = useRef(false);
  const handleWheel = (e) => { if (Math.abs(e.deltaX) < Math.abs(e.deltaY) || Math.abs(e.deltaX) < 2) return; e.preventDefault(); if (wheelLocked.current) return; wheelAccum.current += e.deltaX; clearTimeout(wheelTimeout.current); if (Math.abs(wheelAccum.current) >= 60) { wheelLocked.current = true; if (wheelAccum.current > 0) goTo(currentIndex + 1); else goTo(currentIndex - 1); wheelAccum.current = 0; setTimeout(() => { wheelLocked.current = false; }, 500); } wheelTimeout.current = setTimeout(() => { wheelAccum.current = 0; }, 150); };

  return (
    <section style={{ padding: isMobile ? "90px 0 80px" : "100px 0 120px", overflow: "hidden", opacity: entered ? 1 : 0, transform: entered ? "translateY(0)" : "translateY(40px)", transition: "opacity 0.8s cubic-bezier(0.16,1,0.3,1), transform 0.8s cubic-bezier(0.16,1,0.3,1)" }}>
      <div style={{ paddingLeft: isMobile ? 20 : "max(40px, calc((100vw - 1200px) / 2 + 40px))", cursor: isDragging ? "grabbing" : "grab", userSelect: "none" }} onWheel={handleWheel} onMouseDown={handlePointerDown} onMouseMove={handlePointerMove} onMouseUp={handlePointerUp} onMouseLeave={handlePointerUp} onTouchStart={handlePointerDown} onTouchMove={handlePointerMove} onTouchEnd={handlePointerUp}>
        <div ref={trackRef} style={{ display: "flex", gap, transform: `translateX(${translateX}px)`, transition: isDragging ? "none" : "transform 0.6s cubic-bezier(0.16, 1, 0.3, 1)", willChange: "transform" }}>
          {projects.map((project, i) => {
            const isActive = i === currentIndex; const isHovered = hovered === i; const distance = Math.abs(i - currentIndex);
            const scale = isMobile ? (distance === 0 ? 1 : 0.92) : (distance === 0 ? 1 : 0.85);
            const opacity = distance === 0 ? 1 : distance === 1 ? 0.65 : 0.4;
            const blur = isMobile ? 0 : (distance === 0 ? 0 : distance === 1 ? 3 : 6);
            return (
              <div key={project.id} onMouseEnter={() => setHovered(i)} onMouseLeave={() => setHovered(null)} onClick={() => { if (Math.abs(dragOffset) < 5) { if (i === currentIndex) onSelectProject(project); else goTo(i); } }} style={{ flex: "0 0 auto", width: cardWidth, transform: `scale(${isHovered && isActive ? 1.01 : scale})`, opacity: isDragging ? 0.85 : opacity, filter: blur > 0 ? `blur(${blur}px)` : "none", transition: isDragging ? "none" : "transform 0.6s cubic-bezier(0.16,1,0.3,1), opacity 0.6s cubic-bezier(0.16,1,0.3,1), filter 0.6s cubic-bezier(0.16,1,0.3,1)", willChange: "transform, opacity, filter" }}>
                <div style={{ width: "100%", aspectRatio: "4/5", overflow: "hidden", borderRadius: 4, background: "#eee", marginBottom: isMobile ? 12 : 20 }}>
                  <LazyImage src={project.thumbnail} alt={project.title} draggable={false} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transform: isHovered ? "scale(1.06)" : "scale(1)", transition: "transform 0.7s cubic-bezier(0.16,1,0.3,1)", pointerEvents: "none" }} />
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  <h3 style={{ fontFamily: "'PP Editorial New', 'Playfair Display', Georgia, serif", fontSize: isMobile ? 16 : 20, fontWeight: 400, color: "#1a1a1a", margin: 0 }}>{project.title}</h3>
                  <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: "#999", flexShrink: 0, marginLeft: 12 }}>{project.category}</span>
                </div>
              </div>
            );
          })}
          <div style={{ flex: "0 0 auto", width: isMobile ? 40 : "calc(100vw - 520px)" }} />
        </div>
      </div>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "0 20px" : "0 40px", display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: isMobile ? 24 : 48 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {projects.map((_, i) => (<button key={i} onClick={() => goTo(i)} style={{ width: i === currentIndex ? (isMobile ? 24 : 32) : 8, height: 8, borderRadius: 4, border: "none", background: i === currentIndex ? "#1a1a1a" : "#d4d4d0", cursor: "pointer", padding: 0, transition: "all 0.4s cubic-bezier(0.16,1,0.3,1)" }} />))}
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 12 : 20 }}>
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 13, color: "#999", letterSpacing: "0.04em", minWidth: 48, textAlign: "center" }}>{String(currentIndex + 1).padStart(2, "0")} / {String(projects.length).padStart(2, "0")}</span>
          <button onClick={() => goTo(currentIndex - 1)} disabled={currentIndex === 0} style={{ background: "none", border: "1px solid", borderColor: currentIndex === 0 ? "#e0e0dc" : "#ccc", borderRadius: "50%", width: 44, height: 44, cursor: currentIndex === 0 ? "default" : "pointer", fontSize: 18, color: currentIndex === 0 ? "#ccc" : "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center", opacity: currentIndex === 0 ? 0.4 : 1 }}>&#8592;</button>
          <button onClick={() => goTo(currentIndex + 1)} disabled={currentIndex === maxIndex} style={{ background: "none", border: "1px solid", borderColor: currentIndex === maxIndex ? "#e0e0dc" : "#ccc", borderRadius: "50%", width: 44, height: 44, cursor: currentIndex === maxIndex ? "default" : "pointer", fontSize: 18, color: currentIndex === maxIndex ? "#ccc" : "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center", opacity: currentIndex === maxIndex ? 0.4 : 1 }}>&#8594;</button>
        </div>
      </div>
    </section>
  );
...
function PhotoLightbox({ photo, onClose, onPrev, onNext }) {
  const [show, setShow] = useState(false);
  const isMobile = useIsMobile();
  useEffect(() => { requestAnimationFrame(() => setShow(true)); document.body.style.overflow = "hidden"; const h = (e) => { if (e.key === "Escape") cl(); if (e.key === "ArrowLeft") onPrev(); if (e.key === "ArrowRight") onNext(); }; window.addEventListener("keydown", h); return () => { document.body.style.overflow = ""; window.removeEventListener("keydown", h); }; }, []);
  const cl = () => { setShow(false); setTimeout(onClose, 350); };
  return (
    <div onClick={cl} style={{ position: "fixed", inset: 0, zIndex: 2000, background: show ? "rgba(10,10,10,0.94)" : "rgba(10,10,10,0)", backdropFilter: "blur(20px)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "background 0.35s ease" }}>
      <button onClick={cl} style={{ position: "absolute", top: isMobile ? 16 : 32, right: isMobile ? 16 : 32, background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 14, letterSpacing: "0.08em", textTransform: "uppercase", color: "#fff", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,0.4)" }}>Close</button>
      {!isMobile && <button onClick={(e) => { e.stopPropagation(); onPrev(); }} style={{ position: "absolute", left: 24, top: "50%", transform: "translateY(-50%)", background: "none", border: "1px solid rgba(255,255,255,0.25)", borderRadius: "50%", width: 48, height: 48, cursor: "pointer", fontSize: 20, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>&#8592;</button>}
      {!isMobile && <button onClick={(e) => { e.stopPropagation(); onNext(); }} style={{ position: "absolute", right: 24, top: "50%", transform: "translateY(-50%)", background: "none", border: "1px solid rgba(255,255,255,0.25)", borderRadius: "50%", width: 48, height: 48, cursor: "pointer", fontSize: 20, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>&#8594;</button>}
      <img onClick={(e) => e.stopPropagation()} src={photo.srcLg} alt="" style={{ maxWidth: isMobile ? "94vw" : "88vw", maxHeight: "90vh", objectFit: "contain", opacity: show ? 1 : 0, transform: show ? "scale(1)" : "scale(0.95)", transition: "opacity 0.4s ease, transform 0.4s cubic-bezier(0.16,1,0.3,1)", cursor: "default" }} />
    </div>
  );
}
...
function CollageCell({ photo, index, onClick, style: cellStyle }) {
  ...
  const [visible, setVisible] = useState(false);
  const ref = useRef(null);
  useEffect(() => { const o = new IntersectionObserver(([e]) => { if (e.isIntersecting) setVisible(true); }, { threshold: 0.05 }); if (ref.current) o.observe(ref.current); return () => o.disconnect(); }, []);
  return (
    <div ref={ref} onClick={onClick} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ ...cellStyle, cursor: "pointer", overflow: "hidden", position: "relative", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(20px)", transition: `opacity 0.6s cubic-bezier(0.16,1,0.3,1) ${Math.min(index*50,250)}ms, transform 0.6s cubic-bezier(0.16,1,0.3,1) ${Math.min(index*50,250)}ms` }}>
      <LazyImage src={photo.src} alt="" style={{ width: "100%", height: "auto", display: "block", transform: hovered ? "scale(1.03)" : "scale(1)", transition: "transform 0.7s cubic-bezier(0.16,1,0.3,1)" }} />
    </div>
  );
}
...
function PhotosSection() {
  ...
  const isMobile = useIsMobile();
  const filtered = activeCollection === "all" ? photos : photos.filter((p) => p.collection === activeCollection);
  const navPhoto = (dir) => { const idx = filtered.findIndex((p) => p.id === lightboxPhoto.id); const next = (idx + dir + filtered.length) % filtered.length; setLightboxPhoto(filtered[next]); };
  return (
    <>
      <section style={{ padding: isMobile ? "90px 16px 80px" : "140px 40px 120px", margin: "0 auto" }}>
        <div style={{ marginBottom: isMobile ? 20 : 32, display: "flex", alignItems: "center", gap: isMobile ? 4 : 12, flexWrap: "wrap" }}>
          {photoCollections.map((col) => (<button key={col.id} onClick={() => setActiveCollection(col.id)} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 10 : 12, fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", padding: isMobile ? "8px 10px" : "10px 22px", borderRadius: 0, cursor: "pointer", border: "none", borderBottom: activeCollection === col.id ? "2px solid #1a1a1a" : "2px solid transparent", background: "transparent", color: activeCollection === col.id ? "#1a1a1a" : "#999", transition: "all 0.3s ease" }}>{col.label}</button>))}
        </div>
        <div style={{ columnCount: isMobile ? 2 : 3, columnGap: isMobile ? 4 : 6 }}>
          {filtered.map((photo, i) => (<CollageCell key={photo.id} photo={photo} index={i} onClick={() => setLightboxPhoto(photo)} style={{ breakInside: "avoid", marginBottom: isMobile ? 4 : 6 }} />))}
        </div>
        {filtered.length === 0 && <div style={{ padding: "120px 40px", textAlign: "center", fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#999" }}>No photos in this collection yet.</div>}
      </section>
      {lightboxPhoto && <PhotoLightbox photo={lightboxPhoto} onClose={() => setLightboxPhoto(null)} onPrev={() => navPhoto(-1)} onNext={() => navPhoto(1)} />}
    </>
  );
}
...
/* ─── Hero components ─── */
function HeroName() {
  const ref = useRef(null); const [progress, setProgress] = useState(0); const isMobile = useIsMobile();
  useEffect(() => { const h = () => { if (!ref.current) return; setProgress(Math.max(0, Math.min(1, window.scrollY / (window.innerHeight * 0.45)))); }; window.addEventListener("scroll", h, { passive: true }); h(); return () => window.removeEventListener("scroll", h); }, []);
  const name = "Kelvin Nguyen";
  return (
    <h1 ref={ref} style={{ fontFamily: "'PP Editorial New', 'Playfair Display', Georgia, serif", fontSize: isMobile ? "clamp(36px, 10vw, 52px)" : "clamp(42px, 7vw, 110px)", fontWeight: 400, lineHeight: 1.2, margin: 0, letterSpacing: "-0.02em", whiteSpace: isMobile ? "normal" : "nowrap", overflow: "visible", paddingBottom: 8 }}>
      {name.split("").map((char, i) => { if (char === " ") return <span key={i}>&nbsp;</span>; const total = name.length; const letterStart = (i / total) * 0.3; const letterEnd = letterStart + 0.7; const t = Math.max(0, Math.min(1, (progress - letterStart) / (letterEnd - letterStart))); const ease = t * t; const spreadX = isMobile ? 0 : ease * ((i - total / 2) * 10); return (<span key={i} style={{ display: "inline-block", transform: `translateX(${spreadX}px)`, opacity: 1 - ease * 0.92, filter: ease * 6 > 0.2 ? `blur(${ease * 6}px)` : "none", willChange: "transform, opacity, filter", fontStyle: i > name.indexOf(" ") ? "italic" : "normal", overflow: "visible" }}>{char}</span>); })}
    </h1>
  );
}
...
function HeroSubtext() {
  const ref = useRef(null); const [progress, setProgress] = useState(0); const isMobile = useIsMobile();
  useEffect(() => { const h = () => { if (!ref.current) return; const rect = ref.current.getBoundingClientRect(); setProgress(Math.max(0, Math.min(1, 1 - (rect.top / (window.innerHeight * 0.48))))); }; window.addEventListener("scroll", h, { passive: true }); h(); return () => window.removeEventListener("scroll", h); }, []);
  const sans = "'DM Sans', sans-serif"; const serif = "'PP Editorial New', 'Playfair Display', Georgia, serif";
  const words = [
    { text: "what started out as a gym brand, turned into", font: sans, size: isMobile ? "clamp(14px, 4vw, 18px)" : "clamp(18px, 2.5vw, 28px)", weight: 300, color: "#999", italic: false },
    { text: "an ever-evolving project.", font: serif, size: isMobile ? "clamp(20px, 6vw, 28px)" : "clamp(28px, 4vw, 48px)", weight: 400, color: "#1a1a1a", italic: true, break: true },
  ];
  return (
    <div ref={ref} style={{ maxWidth: isMobile ? "100%" : 700, marginTop: isMobile ? 20 : 40, lineHeight: 1.2, overflow: "visible" }}>
      {words.map((w, i) => { const total = words.length; const wordStart = (i / total) * 0.35; const wordEnd = wordStart + 0.65; const t = Math.max(0, Math.min(1, (progress - wordStart) / (wordEnd - wordStart))); const ease = 1 - Math.pow(1 - t, 3); const y = (1 - ease) * 24; const opacity = 0.06 + ease * 0.94; const blur = (1 - ease) * 4; return (<span key={i}>{w.break && <br />}<span style={{ display: "inline-block", fontFamily: w.font, fontSize: w.size, fontWeight: w.weight, fontStyle: w.italic ? "italic" : "normal", color: w.color, letterSpacing: w.font === sans ? "0.02em" : "0", transform: `translateY(${y}px)`, opacity, filter: blur > 0.2 ? `blur(${blur}px)` : "none", willChange: "transform, opacity, filter" }}>{w.text}</span></span>); })}
    </div>
  );
}
...
function HeroLogo() {
  const ref = useRef(null); const [progress, setProgress] = useState(0); const isMobile = useIsMobile();
  useEffect(() => { const h = () => { if (!ref.current) return; const rect = ref.current.getBoundingClientRect(); setProgress(Math.max(0, Math.min(1, 1 - (rect.top / (window.innerHeight * 0.42))))); }; window.addEventListener("scroll", h, { passive: true }); h(); return () => window.removeEventListener("scroll", h); }, []);
  const ease = 1 - Math.pow(1 - progress, 3);
  return (
    <div ref={ref} style={{ marginTop: isMobile ? 20 : 35, position: "relative", zIndex: 2, paddingLeft: isMobile ? 0 : "clamp(140px, 22vw, 320px)", transform: `translateY(${(1 - ease) * 30}px)`, opacity: 0.05 + ease * 0.95, filter: (1 - ease) * 5 > 0.2 ? `blur(${(1 - ease) * 5}px)` : "none", willChange: "transform, opacity, filter" }}>
      <img src="https://i.imgur.com/5qUiUvI.png" alt="LWKY" style={{ height: isMobile ? 28 : "clamp(32px, 4.5vw, 60px)", width: "auto", display: "block", objectFit: "contain" }} />
    </div>
  );
}
  ...
  return (
    <div style={{ background: "#fafaf8", minHeight: "100vh", color: "#1a1a1a", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        display: "flex", justifyContent: isMobile ? "space-between" : "center", alignItems: "center",
        padding: isMobile ? "0 16px" : "0 40px", height: isMobile ? 56 : 72,
        background: scrolled || mobileMenuOpen ? "rgba(250,250,248,0.96)" : "transparent",
        backdropFilter: scrolled || mobileMenuOpen ? "blur(12px)" : "none",
        borderBottom: scrolled ? "1px solid rgba(0,0,0,0.06)" : "1px solid transparent",
        transition: "all 0.4s ease",
      }}>
        <a href="#" onClick={(e) => { e.preventDefault(); setActiveSection("Work"); setMobileMenuOpen(false); window.scrollTo({ top: 0, behavior: "smooth" }); }}
          style={{ position: isMobile ? "relative" : "absolute", left: isMobile ? 0 : 40, textDecoration: "none", display: "flex", alignItems: "center" }}>
          <img src="https://i.imgur.com/o55Wr1q.png" alt="K.Nguyen" style={{ height: isMobile ? 28 : 36, width: "auto", objectFit: "contain", display: "block" }} />
        </a>
          ...
          <div style={{ display: "flex", gap: 36 }}>
            {NAV_ITEMS.map((item) => (
              <button key={item} onClick={() => { setActiveSection(item); window.scrollTo({ top: 0, behavior: "smooth" }); }}
                style={{ background: "none", border: "none", cursor: "pointer", padding: "4px 0", fontFamily: "'DM Sans', sans-serif", fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", color: activeSection === item ? "#1a1a1a" : "#999", borderBottom: activeSection === item ? "1px solid #1a1a1a" : "1px solid transparent", transition: "all 0.3s ease" }}>{item}</button>
            ))}
          </div>
        )}

        {isMobile && (
          <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} style={{ background: "none", border: "none", cursor: "pointer", padding: 8, display: "flex", flexDirection: "column", gap: 5, justifyContent: "center" }}>
            <span style={{ width: 22, height: 1.5, background: "#1a1a1a", display: "block", transform: mobileMenuOpen ? "rotate(45deg) translateY(3.25px)" : "none", transition: "transform 0.3s ease" }} />
            <span style={{ width: 22, height: 1.5, background: "#1a1a1a", display: "block", transform: mobileMenuOpen ? "rotate(-45deg) translateY(-3.25px)" : "none", transition: "transform 0.3s ease" }} />
          </button>
        )}
      </nav>
      ...
      {isMobile && mobileMenuOpen && (
        <div style={{ position: "fixed", top: 56, left: 0, right: 0, bottom: 0, zIndex: 99, background: "rgba(250,250,248,0.98)", backdropFilter: "blur(20px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 32 }}>
          {NAV_ITEMS.map((item) => (
            <button key={item} onClick={() => { setActiveSection(item); setMobileMenuOpen(false); window.scrollTo({ top: 0, behavior: "smooth" }); }}
              style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "'PP Editorial New', 'Playfair Display', Georgia, serif", fontSize: 28, fontWeight: 400, letterSpacing: "0.02em", color: activeSection === item ? "#1a1a1a" : "#999", fontStyle: activeSection === item ? "italic" : "normal", transition: "all 0.3s ease" }}>{item}</button>
          ))}
        </div>
      )}
          ...
          <section style={{ minHeight: isMobile ? "auto" : "100vh", display: "flex", flexDirection: "column", justifyContent: isMobile ? "flex-start" : "center", padding: isMobile ? "80px 20px 40px" : "0 40px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", position: "relative", zIndex: 2, paddingTop: isMobile ? 20 : 0 }}>
              <div style={{ overflow: "hidden", marginBottom: 12 }}>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 11 : 13, letterSpacing: "0.12em", textTransform: "uppercase", color: "#999", margin: 0, opacity: 0, animation: "fadeUp 0.9s cubic-bezier(0.16,1,0.3,1) 0.2s forwards" }}>Apparel & Graphic Designer</p>
              </div>
              <div style={{ overflow: "visible" }}><HeroName /></div>
              <HeroSubtext />
              <HeroLogo />
            </div>
            ...
            {!isMobile && (
              <div style={{ position: "absolute", bottom: 40, left: 40, display: "flex", alignItems: "center", gap: 12, opacity: 0, animation: "fadeUp 1s cubic-bezier(0.16,1,0.3,1) 0.8s forwards" }}>
                ...
                <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: "#999" }}>Scroll</span>
              </div>
            )}
          </section>

          <section style={{ padding: isMobile ? "24px 16px 60px" : "40px 40px 100px", maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: isMobile ? 24 : 48, borderBottom: "1px solid #e0e0dc", paddingBottom: isMobile ? 12 : 20 }}>
              <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: "#999", margin: 0, fontWeight: 400 }}>Designs & Mockups</h2>
              <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, letterSpacing: "0.1em", color: "#999" }}>{productItems.length} Items</span>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(auto-fill, minmax(100px, 1fr))" : "repeat(auto-fill, minmax(170px, 1fr))", gap: isMobile ? "3px" : "4px" }}>
              {productItems.map((item, i) => (<ProductGridItem key={item.id} item={item} index={i} onClick={() => openLightbox(item)} />))}
            </div>
          </section>
        </>
      )}

      {activeSection === "Collaborations" && <CollaborationsCarousel onSelectProject={setSelectedProject} />}
      {activeSection === "Photos" && <PhotosSection />}

      {/* ═══ ABOUT TAB ═══ */}
      {activeSection === "About" && (
        <section style={{ minHeight: "100vh", padding: isMobile ? "80px 20px 60px" : "140px 40px 120px", maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 80, alignItems: "start" }}>
            <div style={{ aspectRatio: "3/4", background: "#eee", borderRadius: 4, overflow: "hidden", opacity: 0, animation: "fadeUp 1s cubic-bezier(0.16,1,0.3,1) 0.2s forwards" }}>
              <LazyImage src="https://i.imgur.com/Ek5qz6r.jpeg" alt="Portrait" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
            </div>
            <div style={{ opacity: 0, animation: "fadeUp 1s cubic-bezier(0.16,1,0.3,1) 0.4s forwards" }}>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: "#999", marginBottom: 24 }}>About</p>
              <h2 style={{ fontFamily: "'PP Editorial New', 'Playfair Display', Georgia, serif", fontSize: isMobile ? 28 : "clamp(32px, 4vw, 48px)", fontWeight: 400, lineHeight: 1.15, margin: "0 0 24px", color: "#1a1a1a" }}>Designer, brand builder, <em style={{ fontStyle: "italic" }}>creative</em>.</h2>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 14 : 15, lineHeight: 1.8, color: "#555" }}>
              ...
              <div style={{ marginTop: isMobile ? 32 : 48, paddingTop: 24, borderTop: "1px solid #e0e0dc", display: "flex", gap: isMobile ? 24 : 32, flexWrap: "wrap" }}>
                {["Instagram", "Email", "LinkedIn"].map((link) => (
                  <a key={link} href="#" style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, letterSpacing: "0.06em", textDecoration: "none", color: "#1a1a1a", borderBottom: "1px solid #ccc", paddingBottom: 2, transition: "border-color 0.3s" }}
                    onMouseEnter={(e) => e.target.style.borderColor = "#1a1a1a"}
                    onMouseLeave={(e) => e.target.style.borderColor = "#ccc"}>{link}</a>
                ))}
              </div>
            </div>
          </div>
      ...
      {selectedProject && (() => {
        ...
        return (<ProjectDetail project={selectedProject} onClose={() => setSelectedProject(null)} onNext={() => setSelectedProject(projects[idx + 1])} onPrev={() => setSelectedProject(projects[idx - 1])} hasNext={idx < projects.length - 1} hasPrev={idx > 0} />);
      })()}
      {lightboxItem && <ProductLightbox item={lightboxItem} onClose={closeLightbox} onPrev={() => navLightbox(-1)} onNext={() => navLightbox(1)} />}

      <style>{`
        @keyframes heroFloat { 0%, 100% { transform: translateY(0px) translateX(0px); } 25% { transform: translateY(-12px) translateX(4px); } 50% { transform: translateY(-6px) translateX(-3px); } 75% { transform: translateY(-16px) translateX(2px); } }
